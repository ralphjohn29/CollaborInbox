...
@section('title', 'Dispositions Dashboard - CollaborInbox')
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="stat-value">{{ $stats['total_dispositions'] }}</div>
                        </div>
                    </div>
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="stat-value">{{ $stats['active_dispositions'] }}</div>
                        </div>
                    </div>
                    <div class="stat-card">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @forelse ($dispositions as $disposition)
                                    <tr>
                                        <td>
                                            <span class="disposition-color-box" style="background-color: {{ $disposition->color }};"></span>
                                        </td>
                                        <td><strong>{{ $disposition->name }}</strong></td>
                                        ...
                                        <td>{{ $disposition->emails_count }}</td>
                                        <td>{{ $disposition->unread_emails_count }}</td>
                                        <td>
                                            <div class="disposition-actions">
                                                <button class="btn btn-sm btn-outline" onclick="editDisposition({{ $disposition->id }})">Edit</button>
                                                <button class="btn btn-sm btn-outline" onclick="toggleDisposition({{ $disposition->id }})">{{ $disposition->is_active ? 'Deactivate' : 'Activate' }}</button>
                                                @if($disposition->emails_count == 0)
                                                    <button class="btn btn-sm btn-danger" onclick="deleteDisposition({{ $disposition->id }})">Delete</button>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($recentActivity as $activity)
                                    <tr>
                                        <td>{{ Str::limit($activity->subject, 50) }}</td>
                                        <td>{{ $activity->from_email }}</td>
                                        <td>
                                            <span class="disposition-color-box" style="background-color: {{ $activity->disposition_color }};"></span>
                                            <strong>{{ $activity->disposition_name }}</strong>
                                        </td>
...
function openAddModal() {
    ...
    document.getElementById('dispositionForm').action = '{{ route("dispositions.store") }}';
