...
<?php $__env->startSection('title', 'Dashboard - CollaborInbox'); ?>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <a href="<?php echo e(url('/dashboard')); ?>" class="nav-item active">
        ...
        <main class="main-content">
            ...
            <div class="content">
                <div class="page-header">
                    ...
                    <p class="page-description">Welcome back <?php if(auth()->guard()->check()): ?><?php echo e(Auth::user()->name); ?><?php endif; ?>! Here's what's happening with your store today.</p>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\CollaborInbox\resources\views/dashboard.blade.php ENDPATH**/ ?>