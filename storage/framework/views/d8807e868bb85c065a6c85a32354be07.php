        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" id="headerUserDropdown">
                <div style="padding: 0.75rem; border-bottom: 1px solid hsl(var(--border));">
                    <div style="font-weight: 500; color: hsl(var(--foreground));"><?php echo e(Auth::user()->name ?? 'User'); ?></div>
                    <div style="font-size: 0.75rem; color: hsl(var(--muted-foreground)); margin-top: 0.25rem;"><?php echo e(Auth::user()->email ?? ''); ?></div>
                </div>
                ...
                <a href="<?php echo e(route('inbox.settings.dispositions')); ?>" class="dropdown-item">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 0.5rem;">
...
<?php /**PATH D:\CollaborInbox\resources\views/layouts/partials/header.blade.php ENDPATH**/ ?>