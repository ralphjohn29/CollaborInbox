...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        // Tenant subdomain middleware group
        'tenant' => [
    ...
    protected $middlewareAliases = [
        ...
        'tenant.subdomain' => \App\Http\Middleware\InitializeTenancyBySubdomain::class,
        ...
        'email.ratelimit' => \App\Http\Middleware\RateLimitEmailProcessing::class,
    ];
} 